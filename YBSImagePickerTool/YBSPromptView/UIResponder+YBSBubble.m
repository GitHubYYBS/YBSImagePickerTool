...
- (void)showSuccessWithTitle: (NSString *)title autoCloseTime: (CGFloat)autoCloseTime{
    YBSBubbleInfo *info = [self getDefaultRightBubbleInfo];
    info.title = title;
...
- (YBSBubbleInfo *)getDefaultRoundProgressBubbleInfo{
    ...
    info.title = @"请稍候...";
    info.bubbleSize = CGSizeMake(100,80);
    info.maskColor = [UIColor colorWithRed: 0.1 green:0.1 blue:0.1 alpha:0.1];
    info.backgroundColor = [UIColor colorWithRed: 0.1 green:0.1 blue:0.1 alpha:0.5];
...
- (void)hideBubble{
    [[YBSBubbleView defaultBubbleView] hide];
}
